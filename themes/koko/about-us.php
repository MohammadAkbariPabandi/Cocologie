...
<div class="container">
    ...
    <div class="row">
      <div class="col-md-6 herosection-right">
          ...
          <h4 class="base"> 
            ...
            ما معتقدیم که یادگیری باید لذت‌بخش باشد و بازی یکی از قدرتمندترین ابزارهای آموزشی است. پکیج‌های بازی کوکولوژی با هدف ترویج سلامت روان، مهارت‌های اجتماعی، هوش هیجانی و خودآگاهی طراحی شده‌اند.
            در طول سال‌ها، ما با هزاران خانواده، مدرسه و مرکز مشاوره همکاری کرده‌ایم و شاهد تأثیر مثبت بازی‌های ما در زندگی افراد بوده‌ایم. ما به ایجاد تغییر مثبت در جامعه از طریق ترکیب علم روانشناسی و سرگرمی متعهد هستیم.
          </h4>
      </div>
      <div class="col-md-6">
  ...
  <section class="container about-mission">
    <h2 class="mb-3 base" style="color: #d5752c;">ماموریت و چشم‌انداز</h2>
    <h2 class="base" style="color: #04446a;">هدف ما و مسیری که در پیش گرفته‌ایم</h2>
    <div class="row mt-5">
      <div class="col-md-6">
        <div class="about-mission-card">
          <div class="about-mission-card-title mb-4">
            ...
            <h2 class="base" style="color: #04446a;">ماموریت ما</h2>
          </div>
          <p class="body-base base">
            ماموریت ما در کوکولوژی، دموکراتیزه کردن آموزش روانشناسی و ارائه ابزارهای عملی برای رشد فردی و بهبود سلامت روان از طریق بازی‌های جذاب و تعاملی است.
            ما متعهد هستیم که مفاهیم پیچیده روانشناسی را به شکلی قابل فهم و کاربردی ارائه دهیم که برای همه سنین قابل دسترسی باشد و به افراد کمک کند تا خود و دیگران را بهتر درک کنند.
          </p>
        </div>
      </div>
      <div class="col-md-6">
         <div class="about-mission-card">
          <div class="about-mission-card-title mb-4">
            ...
            <h2 class="base" style="color: #04446a;">چشم انداز ما</h2>
          </div>
          <p class="body-base base">
            چشم‌انداز ما ایجاد جهانی است که در آن هر فرد به ابزارهای لازم برای رشد روانشناختی و هیجانی دسترسی داشته باشد و یادگیری مهارت‌های زندگی به بخشی لذت‌بخش از زندگی روزمره تبدیل شود.
            ما می‌خواهیم کوکولوژی به عنوان پیشگام در زمینه آموزش روانشناسی از طریق بازی شناخته شود و به میلیون‌ها نفر در سراسر جهان کمک کند تا زندگی شادتر و سالم‌تری داشته باشند.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="container">
    <h1 class="base mb-5 py-3" style="color: #04446a;">تیم کوکولوژی</h1>
    <div class="aboutTime">
  ...
  <section class="container aboutHistory">
      <h2 class="base mb-5" style="color: #04446a;">تاریخچه کوکولوژی</h2>
      <div class="row">

...
<section class="container herosection">
    <div class="row">
        <div class="col-md-6 herosection-right">
            <p></p>
            <h1 class="mb-5 base" style="color: #091972;">کشف دنیای شگفت انگیز <span><h1 class="base" style="color: #d5752c;" >روانشناسی با بازی</h1></span> </h1>
            <h4 class="base">**با کوکولوژی، روانشناسی را به شیوه‌ای سرگرم‌کننده و جذاب کشف کنید!**  
...
<section class="container kokoGames-section">
    <h2 class="mb-3 base" style="color: #d5752c;">رازهایت را با کوکولوژی کشف کن</h2>
    <h2 class="base" style="color: #04446a;">ما با ترکیب علم روانشناسی و سرگرمی، تجربه‌ای منحصر به فرد برای شما فراهم کرده‌ایم</h2>
...
<section class="container kokoPlay-section">
    <div class="row">
        <div class="col-md-4 kokoPlay-header">
            ...
            <h2 class="base" style="color: #70798B;">راه حل های<span><h1 style="color: #04446a;"> متناسب با نیاز شما</h1></span></h2>
            <p class="mt-5 base body-base" style="color: #70798B;">کوکولوژی با هدف ترکیب علم روانشناسی و سرگرمی تأسیس شده است. ما معتقدیم که یادگیری و خودشناسی می‌تواند لذت‌بخش و سرگرم‌کننده باشد.
